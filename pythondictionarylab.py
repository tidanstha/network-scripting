...
# for key,value in textbook_dict['textbook3'].items():
#    print (f"for textbook4: the {key} key has a value of {value}")
#    if key is 'author':
#        print(textbook_dict['textbook3']['author'])
...
# for key,value in textbook_dict.items():
#    print (f"for textbook4: the {key} key has a value of {value}")
#    if 'author' in textbook_dict == "kevin Ramdas":
#        print(textbook_dict['textbook3']['author'])

# kevin_ramdas_author = False
# for textbook_info in textbook_dict.values():
#     if "author" in textbook_info and textbook_info["author"] == "Kevin Ramdas":
#         kevin_ramdas_author = True
#         break

# if kevin_ramdas_author:
#     print("Yes, 'Kevin Ramdas' is an author of one of the books.")
# else:
#     print("No, 'Kevin Ramdas' is not an author of any of the books.")



#### find out if "jason adalman" is an author of one of the books
# jason_adalman_author = False
# for textbook_info in textbook_dict.values():
#     if "author" in textbook_info and textbook_info["author"] == "Jason Adalman":
#         jason_adalman_author = True
#         break

# if jason_adalman_author:
#     print("Yes, 'Jason Adalman' is an author of one of the books.")
# else:
#     print("No, 'Jason Adalman' is not an author of any of the books.")
